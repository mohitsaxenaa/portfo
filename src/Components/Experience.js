      ...
      <section className="bg-violet-950 text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 pb-32 mx-auto">
          <div className="flex flex-wrap -m-12">
            ...
            <div>
              <h1 className="text-gray-200">More to come soon</h1>
            </div>
