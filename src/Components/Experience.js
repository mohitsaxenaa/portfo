...
const Experience = () => {
  return (
    <div>
      <section className="bg-violet-950 text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 pb-32 mx-auto">
    <div className=" flex flex-wrap -m-12">
      <div className="bg-slate-50 rounded-2xl p-12 md:w-1/2 flex flex-col items-start border">
        ...
        <p className="leading-relaxed mb-8">This law firm gave me and my team the opportunity to design and construct a website, which is an ideal chance for new freelancers. I acquired knowledge of the frontend which include html, css, javascript, and github, as a result.
It was enjoyable working with them to build the Ui/Ux design for this site prior to its creation.
        ...
        <h1 className="flex text-gray-200">more to soon come</h1>
